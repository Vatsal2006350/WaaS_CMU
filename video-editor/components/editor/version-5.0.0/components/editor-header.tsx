...
export function EditorHeader({
  ...
  setOverlays: React.Dispatch<React.SetStateAction<any>>;
  ...
  return (
    <header className="sticky top-0 flex shrink-0 items-center gap-2 bg-gray-900 p-3.5">
      ...
      <RenderControls handleRender={renderMedia} state={state} setOverlays={setOverlays} recommendedOverlays={recommendedOverlays} />
    </header>
  );
}
